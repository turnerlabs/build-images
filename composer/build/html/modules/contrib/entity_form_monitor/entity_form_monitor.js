...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.entityFormMonitor = Drupal.entityFormMonitor || {
    ...
    /**
     * Disables the current form to prevent submission.
     *
     * @name Drupal.entityFormMonitor.disableForm
     */
    disableForm: function() {
      var $entityForms = $('[data-entity-form-monitor]');
      // Disable buttons.
      $entityForms.find('button, input[type="button"], input[type="submit"], input[type="reset"]')
        .prop('disabled', true);
      // Hide the actions in the entity forms.
      //$entityForms.find('.form-actions').hide();
    },
          ...
          success: function (updatedData) {
            $.each(updatedData, function(entityId, lastChanged) {
              ...
              if (lastChanged === false || lastChanged > entityData[entityId]) {
                ...
                Drupal.entityFormMonitor.disableForm();
